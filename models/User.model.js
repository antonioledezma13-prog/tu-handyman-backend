...
const UserSchema = new Schema({
  ...
  // WhatsApp CallMeBot — solo técnicos
  whatsappNumber:    { type: String, default: '' },   // ej: +584121234567
  callmebotApiKey:   { type: String, default: '', select: false },
  whatsappEnabled:   { type: Boolean, default: false }, // activado por el técnico
...
UserSchema.methods.toJSON = function () {
  ...
  delete obj.callmebotApiKey;  // nunca exponer la key al cliente
  return obj;
};
